...
- [Tutorial](/docs/tutorial.md#tutorial)
    ...
    - [Events](/docs/tutorial.md#events)
        - [Event flow](/docs/tutorial.md#event-flow)
            - [Display a child element and ignore effects that would be generated by a mouse-down event.](/docs/tutorial.md#display-a-child-element-and-ignore-effects-that-would-be-generated-by-a-mouse-down-e
vent)
