...
;; (def  mouse-down   (make-mouse-fn  IMouseDown   -mouse-down))
;; (def  mouse-up     (make-mouse-fn  IMouseUp     -mouse-up))
;; (def  mouse-move   (make-mouse-fn  IMouseMove   -mouse-move))
;; (def  mouse-click  (make-mouse-fn  IMouseClick  -mouse-click))
